...
# Exclude client-specific primary stub files so the real PrimaryStub
# implementation becomes part of the common sources compiled into both
# server and client binaries.
CLNT_HDRS := $(filter-out ClientSocket.h, $(wildcard Client*.h))
